...
class SongComponent extends React.Component {
  ...
  render() {
    return (
      this.props.songs.setList ?
        <div className="allSongsContainer">
          <div className="showHeading"> {this.props.songs.showTitle} </div>
          {this.renderSongs(this.props.songs.setList)}

          <ReactAudioPlayer
            src={this.state.track}
            style={{ marginTop: '1em' }}
            setList={this.props.songs.setList}
